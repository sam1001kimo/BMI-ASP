    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div style="width:300px;margin:auto;">
                身高<asp:TextBox ID="tbHeight" runat="server" CssClass="form-control" class="form-control" placeholder="請輸入身高" TextMode="Number" ></asp:TextBox>
            ...
            <div style="width:300px;margin:auto;">
                體重<asp:TextBox ID="tbWeight" runat="server" CssClass="form-control" class="form-control" placeholder="請輸入體重" TextMode="Number"></asp:TextBox>
                ...
                <asp:Button ID="btnResult" runat="server" Style="font-family: 微軟正黑體; font-size: xx-large" Text="計算結果" OnClick="btnResult_Click" CssClass="btn btn-primary" />
